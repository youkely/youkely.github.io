...
======
I am an algorithm enginner at Huawei. I received my M.Sc. degree from [ETH Zurich](https://ethz.ch/en.html) in 2020, under the supervision of Prof. [Marc Pollefeys](https://people.inf.ethz.ch/pomarc/) at Department of Computer Science. Before that, I received B.Eng. degree from UM-SJTU Joint Institute (JI), [Shanghai Jiao Tong University (SJTU)](https://www.sjtu.edu.cn/).
...
Huai, Jianzhu, Yukai Lin, Yuan Zhuang, and Min Shi. "Consistent right-invariant fixed-lag smoother with application to visual inertial SLAM." In *Proceedings of the AAAI Conference on Artificial Intelligence*, vol. 35, no. 7, pp. 6084-6092. ASSOC ADVANCEMENT ARTIFICIAL INTELLIGENCE, 2021.
